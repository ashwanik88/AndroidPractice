...
public class ListViewAdapter extends BaseAdapter
{
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        ...
        if(convertView == null)
        {
            ...
            viewItem.BodyTextView = (TextView)convertView.findViewById(R.id.textviewSubjectBody);
        ...
        viewItem.BodyTextView.setText(TempSubjectList.get(position).Subject_body);
